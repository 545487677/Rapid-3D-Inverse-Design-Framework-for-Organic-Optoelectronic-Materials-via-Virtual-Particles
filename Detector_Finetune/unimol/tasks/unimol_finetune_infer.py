...
task_metainfo = {
    ...
    # infer
    "moleuclar_optimization_res_select_test": {
        "mean": [-5.6457, -2.3304],
        "std": [0.4258, 0.7460],
        "target_name": ["homo", "lumo"],        
    },
    "opv_more_cond": {
        "mean": [-5.6477, -2.3296, 0.3613, 0.5947],
        "std": [0.4243, 0.7460, 0.2843, 0.4477],
        "target_name": ["homo", "lumo", "delta_homo", "delta_lumo"],        
    },   
    "opv_2_0006": {
        # without adding opv_500_2_006
        # "mean": [-5.6457, -2.3304],
