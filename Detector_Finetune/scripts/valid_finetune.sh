...
batch_size=16
task_name='finetune_dft' # data folder name  finetune_dft/general_dft/opt_dft
task_num=2
...
# R2 for Column 0: 0.9041001660496635
# R2 for Column 1: 0.9591031868522145
# MAE for column 0: 0.05434912551806909
# MAE for column 1: 0.06544159558073404
