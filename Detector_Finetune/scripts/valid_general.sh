...
batch_size=16
task_name='general_dft' # data folder name  finetune_dft/general_dft/opt_dft
task_num=2
...
# R2 for Column 0: 0.9283661782389667
# R2 for Column 1: 0.9625266366061805
# MAE for column 0: 0.046729795925292986
# MAE for column 1: 0.06647372299015046